package com.graphicdesign.hollowknight.model.scenes;
...
public class Hud implements Disposable {
    ...
    public Hud(SpriteBatch spriteBatch) {
        ...
        timeCount = 0f;
        score = 0;
        viewport = new FitViewport(HollowKnight.V_WIDTH, HollowKnight.V_HEIGHT, new OrthographicCamera());
        ...
        knightLabel = new Label("KNIGHT", new Label.LabelStyle( font, Color.WHITE));

        table.add(knightLabel).expandX().padTop(10);
